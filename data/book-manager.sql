...
insert  into `tb_menu`(`menu_id`,`menu_name`,`parent_id`,`order_num`,`path`,`component`,`query`,`route_name`,`is_frame`,`is_cache`,`menu_type`,`visible`,`status`,`perms`,`icon`,`create_by`,`create_time`,`update_by`,`update_time`,`remark`) values (2030,'图书管理',0,4,'/bookmanager',NULL,NULL,'',1,0,'M','0','0',NULL,'documentation','admin','2025-05-02 22:45:06','',NULL,''),(2031,'读者管理',2030,1,'reader','bookmanager/reader/index',NULL,'',1,0,'C','0','0','','peoples','admin','2025-05-02 22:47:25','admin','2025-05-02 22:51:00',''),(2033,'图书管理',2030,2,'book','bookmanager/book/index',NULL,'',1,0,'C','0','0','','chart','admin','2025-05-02 22:51:51','admin','2025-05-02 22:53:36',''),(2034,'借阅管理',2030,3,'borrow','bookmanager/borrow/index',NULL,'',1,0,'C','0','0','','form','admin','2025-05-02 22:52:48','admin','2025-05-02 22:54:29',''),(2060,'评论管理',2030,4,'review','bookmanager/review/index',NULL,'',1,0,'C','0','0','','rate','admin','2025-05-15 00:00:00','',NULL,'评论管理菜单'),(2061,'评论管理查询',2060,1,'#','',NULL,'',1,0,'F','0','0','bookmanager:review:query','#','admin','2025-05-15 00:00:00','',NULL,''),(2062,'评论管理修改',2060,2,'#','',NULL,'',1,0,'F','0','0','bookmanager:review:edit','#','admin','2025-05-15 00:00:00','',NULL,''),(2063,'评论管理删除',2060,3,'#','',NULL,'',1,0,'F','0','0','bookmanager:review:remove','#','admin','2025-05-15 00:00:00','',NULL,''),(2035,'系统',0,5,'system',NULL,NULL,'',1,0,'M','0','0',NULL,'system','admin','2025-05-02 22:57:17','',NULL,''),(2036,'修改密码',2035,1,'changepassword','system/changepassword/index',NULL,'',1,0,'C','0','0','','password','admin','2025-05-02 22:58:27','admin','2025-05-02 22:59:18',''),(2038,'读者管理',2031,1,'reader','bookmanager/reader/index',NULL,'',1,0,'C','0','0','bookmanager:reader:list','#','admin','2025-05-02 23:44:18','',NULL,'读者管理菜单'),(2039,'读者管理查询',2038,1,'#','',NULL,'',1,0,'F','0','0','bookmanager:reader:query','#','admin','2025-05-02 23:44:18','',NULL,''),(2040,'读者管理新增',2038,2,'#','',NULL,'',1,0,'F','0','0','bookmanager:reader:add','#','admin','2025-05-02 23:44:18','',NULL,''),(2041,'读者管理修改',2038,3,'#','',NULL,'',1,0,'F','0','0','bookmanager:reader:edit','#','admin','2025-05-02 23:44:18','',NULL,''),(2042,'读者管理删除',2038,4,'#','',NULL,'',1,0,'F','0','0','bookmanager:reader:remove','#','admin','2025-05-02 23:44:18','',NULL,''),(2044,'图书管理',2033,1,'book','bookmanager/book/index',NULL,'',1,0,'C','0','0','bookmanager:book:list','#','admin','2025-05-09 20:35:46','',NULL,'图书管理菜单'),(2045,'图书管理查询',2044,1,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:book:query','#','admin','2025-05-09 20:37:33','',NULL,''),(2046,'图书管理新增',2044,2,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:book:add','#','admin','2025-05-09 20:38:52','',NULL,''),(2047,'图书管理修改',2044,3,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:book:edit','#','admin','2025-05-09 20:40:00','',NULL,''),(2048,'图书管理删除',2044,4,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:book:remove','#','admin','2025-05-09 20:40:57','',NULL,''),(2049,'借阅管理',2034,1,'borrow','bookmanager/borrow/index',NULL,'',1,0,'C','0','0','bookmanager:borrow:list','#','admin','2025-05-10 23:32:25','',NULL,''),(2050,'借阅管理查询',2049,1,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:borrow:query','#','admin','2025-05-10 23:34:31','',NULL,''),(2051,'借阅管理借阅',2049,2,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:borrow:add','#','admin','2025-05-10 23:36:12','',NULL,''),(2052,'借阅管理修改',2049,3,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:borrow:edit','#','admin','2025-05-10 23:37:17','',NULL,''),(2053,'借阅管理删除',2049,4,'#',NULL,NULL,'',1,0,'F','0','0','bookmanager:borrow:remove','#','admin','2025-05-10 23:38:23','',NULL,'');
...
DROP TABLE IF EXISTS `tb_book_review`;
CREATE TABLE `tb_book_review` (
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '1' COMMENT '状态（0隐藏 1显示）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='图书评论表';
